                ...
                <section className={'tongue-thrust-content-container'}>
                    ...
                    <div className={'tongue-thrust-content-wrapper'}>
                        <div className={'tongue-thrust-content-copy'}>
                            <p>A tongue thrust describes a dysfunctional swallowing pattern in which an individual pushes the tongue against or between the teeth during swallowing. Often times, a low resting tongue posture or “tongue thrust” is merely a symptom of a larger issue.</p>
